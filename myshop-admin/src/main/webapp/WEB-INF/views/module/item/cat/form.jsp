            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">${tbItemCat.id == "0" ?"新增":"编辑"}商品信息</h3>
                        <div class="row">
                        </div>
                        <!-- /.box-header -->

                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/item/cat/save" method="post" modelAttribute="tbItemCat">
                            <form:hidden path="id"/>
                            <div class="box-body ">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control required" id="categoryPid" readonly="true" placeholder="请选择" value="${tbItemCat.parentName.name  eq null ? '/': tbItemCat.parentName.name}"/>
                                    </div>
                                </div>
