                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="row" style="padding-left:10px;">
                                <a href="/content/category/form" type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i>添加</a> &nbsp
                        ...
                        <div class="box-body">
                            <table id="treeTable" class="table table-bordered table-hover text-nowrap text-center ">
                                ...
                                <c:forEach items="${tbContentCategories}" var="tbContentCategorie">
                                    <tr id="${tbContentCategorie.id}" pId="${tbContentCategorie.parentId}">
                                        <td>${tbContentCategorie.name}</td>
                                        <td>${tbContentCategorie.sortOrder}</td>
                                        <td><fmt:formatDate value="${tbContentCategorie.updated}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                        <td>
                                            <a href="/content/category/form?id=${tbContentCategorie.id}&name=${tbContentCategorie.name}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a> &nbsp &nbsp
                                            <a  href="javascript:void(0);" onclick="datatable.showDelete('/content/category/delete?id=${tbContentCategorie.id}')" type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i>删除</a> &nbsp &nbsp
                                            <a  href="/content/category/form?id=${tbContentCategorie.id}&name=" type="button" class="btn btn-sm btn-default"><i class="fa fa-plus"></i>下级菜单目录</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
