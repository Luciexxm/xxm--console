            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">${tbItem.id == "0" ?"新增":"编辑"}商品信息</h3>
                        <div class="row">
                        </div>
                        <!-- /.box-header -->
                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/item/save" method="post" modelAttribute="tbItem">
                            ...
                            <div class="box-body ">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <form:hidden id="categoryId" path="tbItemCat.id" />
                                        <input class="form-control required" id="categoryPid" readonly="true" placeholder="请选择" value="${tbItem.tbItemCat.name}"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    <label for="sellPoint" class="col-sm-2 control-label">卖点</label>
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="sellPoint" placeholder="卖点"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="tbItemDesc.itemDesc" class="col-sm-2 control-label">商品内容</label>
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="tbItemDesc.itemDesc" placeholder="商品内容"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="price" placeholder="价格"/>
                                    </div>
                                </div>

                                <div class="form-group ">
                                    <label for="barcode" class="col-sm-2 control-label">二维码</label>
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="barcode" placeholder="二维码"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <form:input cssClass="form-control " path="image" placeholder="图片1"/>
                                    </div>
                                </div>
...
<script>
    ...
    datatable.initDropZone("dropzoneUpload1", "image")

    $(function () {

    //    console.log(ue.loadServerConfig());
        datatable.initDateTree("cat/dataTree");
